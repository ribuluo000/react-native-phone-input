...
export default class PhoneInput extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      disabled,
      formattedNumber: '',
      countryDialCode: countryData ? `+${countryData.dialCode}` : '',
      value: null
    };
  }
  ...
  getDialCode() {
    return PhoneNumber.getDialCode(this.state.countryDialCode + this.state.formattedNumber);
  }

  getValue() {
    return this.state.countryDialCode + this.state.formattedNumber;
  }

  getNumberType() {
    return PhoneNumber.getNumberType(
      this.state.countryDialCode + this.state.formattedNumber,
      this.state.iso2
    );
  }
  ...
  updateFlagAndFormatNumber(number, actionAfterSetState = null) {
    this.setState({ formattedNumber: number }, actionAfterSetState);
  }
  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.style]}>
        ...
        <Text
          style={this.props.textStyleDialCode}
          onPress={this.onPressFlag}
        >
